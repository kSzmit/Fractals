...
Interface::Interface(Application* appPtr, int fractalType) : m_fractalType(fractalType), m_appPtr(appPtr){
	...
	m_desktop.Add(m_terrainWindow.getWindow());
...
bool Interface::terrainGenerate(){
	return m_terrainWindow.checkGenerate();
}
